...
// const monotonicRepeat = (i, r) => {
//   const mod = i % r
//   return (mod === 0 ? i : i - mod) / r
// }

// const spacing = (size) => {
//   const lineHeights = [ 0, 1, 2, 3, 5, 6, 8, 8, 9, 10, 13, 13, 14, 15, 17, 17, 18, 20, 22, 22, 23, 24, 26, 26, 28, 29, 31, 31, 32, 33, 36, 36, 37 ]

//   const lineHeight = lineHeights[size]
//   return {
//     font: size,
//     padding: lineHeight - monotonicRepeat(size, 4),
//     lineHeight
//   }
// }
