...
tape('polygon subtraction', t => {
  ...
  screenshot(`${__dirname}/../../../test/csg/csg-subtract`, canvas, t);
});
...
tape('polygon addition', t => {
  ...
  screenshot(`${__dirname}/../../../test/csg/csg-union`, canvas, t);
});
...
tape('polygon intersection', t => {
  ...
  screenshot(`${__dirname}/../../../test/csg/csg-intersection`, canvas, t);
});
