...
class Label extends Layout { // TODO: add check to ensure labels have NO children
...
class Margin extends Layout {
  ...
  position (renderContext, { top, right, bottom, left }, updatedParentPosition, childCount) { // eslint-disable-line no-unused-vars
    ...
    return Array(childCount).fill(Object.assign({}, {
...
module.exports = {
  Layout, Root, Label, Margin, SpacedLine, Button, Viewport //, Offset, Grid, Checkbox
}
