...
const exampleTextWright = hyphenateEnglish(
  fs.readFileSync('./test/fixtures/wright.txt', 'utf-8')
);

module.exports = ({x, y, width, height}) => {
  const textContinuation = createTextContinuation(exampleText);
  const textContinuationWright = createTextContinuation(exampleTextWright);
          ...
          c(
            ...
            c(
              ...
              c(Label, {
                ...
                size: 20,
                sizeMode: 'capHeight',
                text: `The Wright Brothers' Aeroplane`,
                showBoxes
              })
            ),
            c(Text, {
              ...
              size: 12,
              sizeMode: 'capHeight',
              textContinuation: textContinuationWright,
              operation: 'add',
              overflow: 'continue',
              color: 'black',
              showBoxes,
